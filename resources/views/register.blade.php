    ...
    <div class="w-full max-w-md bg-white p-8 rounded-xl shadow-md space-y-6">
      ...
      <form action="#" method="POST" class="space-y-4">
        <div class="flex gap-4">
          <div class="w-1/2">
            ...
            <input type="text" name="prenom" id="prenom" required
              class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-600 sm:text-sm"
              placeholder="">
          </div>
        ...
        <div class="flex items-center">
          <input type="checkbox" name="agree" id="agree" class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
        ...
        <div class="text-center mt-4">
          ...
          <a href="{{ route('login') }}" class="mt-2 inline-block text-sm font-medium text-indigo-600 hover:text-indigo-500">Se connecter</a></p>
        </div>
      </form>
    </div>
  </div>
