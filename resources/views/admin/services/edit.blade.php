...
<div class="max-w-xl mx-auto p-8 bg-white/80 backdrop-blur rounded-3xl shadow-2xl animate-fade-in-up">
    <div class="flex items-center mb-6">
        ...
        <h2 class="text-2xl font-bold text-blue-700 ml-4">Modifier le service</h2>
    </div>
    @if ($errors->any())
    ...
    <form action="{{ route('admin.services.update', $service->id) }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="titre" value="{{ old('titre', $service->titre) }}" class="border border-gray-200 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
        </div>
