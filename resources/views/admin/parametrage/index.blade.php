...
@section('content')
<div class="max-w-4xl mx-auto p-8 bg-white/80 backdrop-blur rounded-3xl shadow-2xl animate-fade-in-up">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        <h2 class="text-2xl font-bold text-blue-700">Paramétrage</h2>
    </div>
